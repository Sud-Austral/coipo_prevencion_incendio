...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link name="SDE Feature Class" type="ArcSDE Connection" format="" mimeType="" size="" url="Server=172.22.110.36; Service=5151; Database=sde; User=geosde; Version=SDE.DEFAULT" description=""/>
  </links>
  <dates/>
  <fees></fees>
  ...
  <extent>
    <spatial miny="3794823.35760000022128224" dimensions="2" crs="EPSG:4326" minx="-8496.1213000000007014" minz="0" maxz="0" maxx="704690.56019999994896352" maxy="8065196.81630000006407499"/>
    <temporal>
      <period>
        <start></start>
        <end></end>
