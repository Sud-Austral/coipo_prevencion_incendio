...
| --- | ---: | --- |
| `README_CANDIDATE.md` | 6 KB | El revisor no se pronuncio sobre este archivo. El detector lo marco como artefacto del generador. |
| `INSUMO_INCENDIO/OECV 2025 - 2026/15.- Aysén/Planificado/Resumen OECV(1).xlsx` | 21 KB | El revisor no se pronuncio sobre este archivo. El detector lo marco como variante o respaldo. |
